...
#include <Windows.h>
#include "CompiledSkyboxPixelShader.hlsl.h"
#include "CompiledSkyboxVertexShader.hlsl.h"
...
void SkyboxShader::LoadVertexShader()
{
