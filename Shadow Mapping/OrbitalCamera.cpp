...
void OrbitalCamera::Rotate(float pitch_radians, float yaw_radians)
{
	...
	// Store OrbitalCamera position
	DirectX::XMStoreFloat3(&m_Position, position);

	// Calculate OrbitalCamera's view
...
void OrbitalCamera::UpdateAspectRatio(int width, int height)
{
...
void OrbitalCamera::UpdateFov(float fov)
{
...
void OrbitalCamera::CalculateProjection()
{
